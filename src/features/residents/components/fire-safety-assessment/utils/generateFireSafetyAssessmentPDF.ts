...
/**
 * Type definitions for Fire Safety Assessment Form data
 */
export interface FireSafetyAssessmentFormData {
  responseToAlarm?: string;
  responseToInstruction?: string;
  visionAndHearing?: string;
  impairedConsciousness?: string;
  mobility?: string;
  resistance?: string;
  sleepHours?: string;
  nonSleepHours?: string;
  emergencyBackupName?: string;
  emergencyBackupNumber?: string;
  personSpecificInfo?: string;
...
const fieldLabels: Record<string, string> = {
  responseToAlarm: 'Response to alarm',
  responseToInstruction: 'Response to instruction',
  visionAndHearing: 'Vision and Hearing',
  impairedConsciousness: 'Impaired Consciousness',
  mobility: 'Mobility',
  resistance: 'Resistance',
  sleepHours: 'Sleep Hours',
  nonSleepHours: 'Non-sleep Hours',
  emergencyBackupName: 'Emergency Backup Name',
  emergencyBackupNumber: 'Emergency Backup Number',
  personSpecificInfo: 'Person specific information and instruction to Staff & Provider, regarding the Individual and his/her Evacuation needs',
...
const stepConfigs: StepConfig[] = [
  {
    ...
    sections: [
      {
        sectionTitle: 'Risk of problems in:',
        fields: ['responseToAlarm', 'responseToInstruction', 'visionAndHearing', 'impairedConsciousness', 'mobility', 'resistance'],
      },
      {
        sectionTitle: 'Staff / provider to Resident ratio:',
        fields: ['sleepHours', 'nonSleepHours'],
      },
      {
        sectionTitle: '24-hour emergency backup provided by:',
        fields: ['emergencyBackupName', 'emergencyBackupNumber'],
      },
      {
        sectionTitle: 'Person specific information',
        fields: ['personSpecificInfo'],
      },
      {
        sectionTitle: 'Completion Information',
        fields: ['dateCompleted', 'signature'],
      },
    ],
  },
];
...
/**
 * Generate PDF for Fire Safety Assessment Form
 */
export function generateFireSafetyAssessmentPDF(
  formData: FireSafetyAssessmentFormData,
  ...
  pdf.setFontSize(18);
  pdf.setTextColor(0, 0, 0);
  const title = 'Fire Safety Assessment';
